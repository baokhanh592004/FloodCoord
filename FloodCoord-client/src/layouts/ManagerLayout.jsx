  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-white text-gray-900 flex flex-col border-r border-gray-200 shadow-sm">
        ...
        {/* User Info */}
        <Link to="/profile" className="px-6 py-4 border-b border-slate-200 flex items-center gap-3 hover:bg-blue-50 transition-colors group">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold text-gray-800 truncate group-hover:text-blue-600">
              {profileName || user?.fullName || 'Manager'}
            </p>
