...
export default function Footer() {
  return (
    <footer className="bg-gray-800 from-blue-600 via-cyan-600 to-teal-600 text-white">
      <div className="w-full px-16 py-4 grid md:grid-cols-[2fr_1fr_1fr] gap-12">
        ...
        <div>
          <div className="flex items-center gap-4 mb-3">
            ...
            <h3 className="text-teal-300 text-[25px] font-semibold">
        ...
        <div>
          <h3 className="text-white text-[25px] font-semibold mb-3">Liên kết nhanh</h3>
          <ul className="space-y-2 text-sm">

            <li>
              <Link to="/request-rescue" className="text-[18px] text-white hover:text-gray-200 transition">
                Gửi yêu cầu cứu trợ
              </Link>
            </li>

            <li>
              <Link to="/track-rescue" className="text-[18px] text-white hover:text-gray-200 transition">
                Tra cứu cứu hộ
              </Link>
            </li>
        ...
        {/* Column 3 - Contact */}
        <div>
          <h3 className="text-white text-[25px] font-semibold mb-3">Liên hệ khẩn cấp</h3>
